...
import { Copy, Check, Play, ChevronRight, Database, Code, Terminal, BookOpen } from "lucide-react";
...
export default function ApiDocs() {
  ...
  return (
    <div data-testid="api-docs-page" className="space-y-8 animate-fade-in">
      {/* Header */}
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
        <div>
          <h1 className="text-4xl font-extrabold text-zinc-50 tracking-tight">Documentação da API</h1>
          <p className="text-zinc-500 mt-2 max-w-2xl">
            API RESTful para consulta e gerenciamento do cardápio. Ideal para estudantes 
            aprenderem a consumir APIs em aplicações frontend.
          </p>
        </div>
      ...
      <Card className="border-zinc-800 bg-zinc-900/50 border-orange-500/20">
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            <h4 className="text-sm font-medium text-zinc-300 mb-2">Exemplo com fetch (JavaScript):</h4>
...
fetch('${API_BASE}/api/produtos', {
  ...
  body: JSON.stringify({
    ...
    destacado: false
          ...
          <div>
            <h4 className="text-sm font-medium text-zinc-300 mb-2">Exemplo com curl:</h4>
