...
const navItems = [
  ...
  { to: "/dashboard/produtos/novo", icon: Plus, label: "Novo Produto" },
];
    ...
    <div className="flex min-h-screen">
      ...
      <aside className="fixed left-0 top-0 h-full w-64 bg-zinc-950/80 backdrop-blur-xl border-r border-zinc-800 z-40">
        ...
        <nav className="p-4 space-y-1">
          ...
          {/* Link para documentação pública */}
          <a
            href="/"
            data-testid="nav-documentacao"
            className="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all text-zinc-400 hover:text-zinc-50 hover:bg-zinc-800/30"
          >
